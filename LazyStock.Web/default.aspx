                    ...
                    <div class="navbar-brand">
                        <h3>
                            ...
                            <a href="." class="white-text">
                                <img src="img/LazyStockLogo5.png?t=<%=DateTime.Now.ToString("yyyyMMddHHmmssfff") %>" /></a>
                        </h3>
                    </div>
                    <!-- /Logo -->
                ...
                <div class="row">
                    ...
                    <div class="col-md-10 col-md-offset-1">
                        <div class="home-content">
                            ...
                            <p class="white-text">我們懶的操股，我們只想花最少的工，獲得最大的勝率<br />
                                當你學會了慢，你獲得的不止是金錢，還有更多的時間</p>
                    ...
                    <div class="panel-heading">
                        <form class="form-inline" role="form">
                            <div class="form-group">
                                ...
                                <a href="LineLoginAuth.aspx" id="LineAuth2">
                                    <img src="img/line/44dp/btn_login_base.png" /></a>
                            </div>
                        </form>
                    </div>
                </div>
                        ...
                        <div class="panel-body">
                            <table class="table table-bordered table-responsive">
                                <tr>
                                    ...
                                    <td>
                                        <button type="button" class="btn btn-success btn-circle StockStatusBtnGroup" id="btnIsPromisingEPS"><i class="fa fa-check"></i></button>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <button type="button" class="btn btn-success btn-circle StockStatusBtnGroup" id="btnIsGrowingUpEPS"><i class="fa fa-check"></i></button>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <button type="button" class="btn btn-success btn-circle StockStatusBtnGroup" id="btnIsAlwaysIncomeEPS"><i class="fa fa-check"></i></button>
                                    </td>
                                </tr>
                            </table>
                        </div>
